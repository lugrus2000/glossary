...
<iframe width="560" height="315" src="https://www.youtube.com/embed/0vChvk1-uCg" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
Around App Services, you can also configure a lot of features for example different deployment solutions,  [Authorization](/topic/en/aad_authorization) and [Authentication](/topic/en/test_authentication), [Identity](/topic/en/aad_identity), Backups, Custom domains, [TLS](/topic/en/tls-ssl_tls) and [SSL](/topic/en/tls-ssl_ssl) to enable [HTTPS](/topic/en/tls-ssl_https), you can also automatically scale up and scale down for example to respond to a lot of demand very fast.
